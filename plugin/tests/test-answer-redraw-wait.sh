...
slow.write_text(
    ...
    encoding="utf-8")
mt._AGENT_CLIS["fake"] = lambda sid, prompt="", model="", effort="", profile="", lean=False: [
...
fast.write_text(
    ...
    "    sys.stdout.write('QUESTION ' + 'x' * 200 + '\\n'); sys.stdout.flush()\n",
    encoding="utf-8")
mt._AGENT_CLIS["fake"] = lambda sid, prompt="", model="", effort="", profile="", lean=False: [sys.executable, str(fast)]
